...
const ZargeSVG = ({ height = 60, fill = themeColors.Zarge, type, isHovered = false }: {
    height?: number;
    fill?: string;
  ...
  <g>
    ...
    {type === "Futterraum" && <rect x="72" y={height / 2 - 2} width="6" height="4" fill={themeColors.Futterraum} stroke="#A04030" strokeWidth="1" />}
